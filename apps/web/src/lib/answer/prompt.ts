...
- For portfolio-demo medicine cards, if selected_evidence supports the medicine name but one or more fields are still "本地资料未列出", actively use Google Search grounding to fill medication_fields.external_search_note with the most important missing indication, dosage-boundary, contraindication, caution, or adverse-reaction context. Keep the structured local fields as "本地资料未列出" when the field is not in selected_evidence; the external note is the visible supplement.
